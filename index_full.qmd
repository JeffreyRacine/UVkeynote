...
-   Classical regression analysis dates to @galton:1894 and @pearson:1896 in the late 19th century

-   A **defining feature of classical regression analysis** is that **sample elements are random pairs**, $(y_i,x_i)$, while the *function of interest* $\mathbb{E}(Y|X=x)$ is *non-random*

-   Functional data analysis (FDA) dates to @grenander:1950 and @karhunen:1946 in the mid 20th century

-   A **defining feature of functional data analysis ** is that **sample elements are random functions**, $X^{(i)}$, which are *also functions of interest*
...
-   We link process regularity to sample path regularity
...
## Appendix F: Online Recursive Updating Clip {#appmovie}
